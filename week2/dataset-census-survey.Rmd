...
with them. The margin of error the census reports is for a 90-percent
confidence level.
...
Here's a little video that explains more about margins of error:

https://www.census.gov/data/academy/data-gems/2024/what-is-the-margin-of-error.html.
...
about the occupancy status of housing units. It includes three variables:
...
Congressional Districts in Utah. It includes an estimate and a margin of error 
(for 90-percent confidence) for each of three variables:
